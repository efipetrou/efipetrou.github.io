...
<ProjectBlock first={true}>
  ...
  <figure slot="images" class="w-2/3 sm:w-1/2 m-auto sm:p-8 4xl:pb-24">
...
<ProjectBlock>
  ...
  <div slot="images" class="flex flex-wrap justify-items-start items-center sm:w-1/2 sm:pt-8 sm:px-8 sm:pb-4 4xl:pb-24">
