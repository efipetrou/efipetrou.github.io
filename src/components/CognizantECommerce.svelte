...
<div class="grid grid-cols-2 mb-8 text-sm sm:relative sm:text-base lg:text-xl 2xl:text-2xl 4xl:text-3xl">
  <p class="col-span-2 mb-8 lg:col-span-1 sm:mt-8 4xl:mb-2">I was one of the 2 designers responsible for redesigning some of the key features of the e-commerce platform for this Dutch agricultural machine manufacturer in order to increase the leads and the conversion of their website.</p>
...
<div class="flex items-center mb-4 justify-items-center sm:mb-8 bg-cognizant-ecommerce">
